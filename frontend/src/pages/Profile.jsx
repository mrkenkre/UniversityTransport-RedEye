      ...
      <Navbar bg="dark" variant="dark">
        <Container>
          <Navbar.Brand href="/home">
            <img
              alt=""
              src={require("./NU_MonoLVX_RGB_RW.png")}
              width="30"
              height="30"
          ...
          {location.pathname.includes("healthcare") ||location.pathname.includes("healthCare")  ? (
            <>
            ...
            <li>
              <Link
                ...
                className={
                  ...
                  location.pathname === "/home/add-products"
                    ? "nav-link scrollto active"
                    : "nav-link scrollto"
                }
              >
